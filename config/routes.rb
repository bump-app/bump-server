Rails.application.routes.draw do
  scope '/api' do
    ...
    jsonapi_resources :friendship_settings
...
#  friendship_relationships_friendship_setting GET       /api/friendships/:friendship_id/relationships/friendship-setting(.:format)          friendships#show_relationship {:relationship=>"friendship_setting"}
#                                              PUT|PATCH /api/friendships/:friendship_id/relationships/friendship-setting(.:format)          friendships#update_relationship {:relationship=>"friendship_setting"}
#                                              DELETE    /api/friendships/:friendship_id/relationships/friendship-setting(.:format)          friendships#destroy_relationship {:relationship=>"friendship_setting"}
#                friendship_friendship_setting GET       /api/friendships/:friendship_id/friendship-setting(.:format)                        friendship_settings#get_related_resource {:relationship=>"friendship_setting", :source=>"friendships"}
...
# friendship_setting_relationships_friendships GET       /api/friendship-settings/:friendship_setting_id/relationships/friendships(.:format) friendship_settings#show_relationship {:relationship=>"friendships"}
#                                              POST      /api/friendship-settings/:friendship_setting_id/relationships/friendships(.:format) friendship_settings#create_relationship {:relationship=>"friendships"}
#                                              PUT|PATCH /api/friendship-settings/:friendship_setting_id/relationships/friendships(.:format) friendship_settings#update_relationship {:relationship=>"friendships"}
#                                              DELETE    /api/friendship-settings/:friendship_setting_id/relationships/friendships(.:format) friendship_settings#destroy_relationship {:relationship=>"friendships"}
#               friendship_setting_friendships GET       /api/friendship-settings/:friendship_setting_id/friendships(.:format)               friendships#get_related_resources {:relationship=>"friendships", :source=>"friendship_settings"}
#                          friendship_settings GET       /api/friendship-settings(.:format)                                                  friendship_settings#index
#                                              POST      /api/friendship-settings(.:format)                                                  friendship_settings#create
#                           friendship_setting GET       /api/friendship-settings/:id(.:format)                                              friendship_settings#show
#                                              PATCH     /api/friendship-settings/:id(.:format)                                              friendship_settings#update
#                                              PUT       /api/friendship-settings/:id(.:format)                                              friendship_settings#update
#                                              DELETE    /api/friendship-settings/:id(.:format)                                              friendship_settings#destroy
